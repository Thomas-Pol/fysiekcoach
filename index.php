    ...
    <!-- Hero Section -->
    <section id="hero"
        class="relative bg-gradient-to-br from-gray-50 via-white to-gray-100 py-20 md:py-32 overflow-hidden">
        <!-- Background Pattern -->
        <div class="absolute inset-0 opacity-5">
            ...
            <div
                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#E07603] rounded-full blur-3xl">
            </div>
        </div>
        ...
        <div class="container mx-auto px-6 md:px-8 lg:px-12 max-w-7xl relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="space-y-8">
                    <!-- Badge -->
                    <div
                        class="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-200 shadow-sm">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="javascript:void(0);" onclick="scrollToContact()"
                            class="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#E07603] to-[#E07603]/90 text-white px-8 py-4 rounded-2xl hover:from-[#E07603]/90 hover:to-[#E07603]/80 transition-all font-semibold text-lg hover-lift shadow-xl">
                            <span>Start vandaag</span>
                            <i data-lucide="arrow-right" class="w-5 h-5"></i>
                        </a>
                        <a href="#services"
                            class="inline-flex items-center justify-center gap-3 bg-white text-gray-800 px-8 py-4 rounded-2xl hover:bg-gray-50 transition-all font-semibold text-lg border border-gray-200 hover-lift shadow-lg">
                ...
                <div class="relative">
                    <div class="relative z-10 rounded-3xl overflow-hidden shadow-2xl hover-lift">
                        <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800&q=80"
                            alt="Moderne werkplek met ergonomische inrichting" class="w-full h-[600px] object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-gray-900/20 to-transparent"></div>
                    </div>

                    <!-- Floating Card -->
                    <div
                        class="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-xl border border-gray-200 z-20 max-w-sm">
        ...
        <div class="container mx-auto px-6 md:px-8 lg:px-12 max-w-7xl">
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="group relative">
                    <div
                        class="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 md:p-10 border border-gray-200 hover:border-[#E07603]/30 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
                        <!-- Service Header -->
                        <div class="flex items-start justify-between mb-8">
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-[#E07603] to-[#E07603]/80 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                <i data-lucide="monitor" class="w-8 h-8 text-white"></i>
                            </div>
                            <div class="w-6 h-6 bg-gray-200 rounded-full group-hover:bg-[#E07603] transition-colors">
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <a href="/Glu/jaar_3/Fysiekcoach/ergonoom"
                                class="inline-flex items-center gap-2 text-[#E07603] font-semibold hover:gap-4 transition-all group-hover:text-gray-800">
                ...
                <div class="group relative">
                    <div
                        ...
                        <div class="flex items-start justify-between mb-8">
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div class="text-center mt-20">
                <div
                    class="bg-gradient-to-r from-gray-800 to-gray-700 rounded-3xl p-12 md:p-16 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <a href="javascript:void(0);" onclick="scrollToContact()"
                            class="inline-flex items-center gap-3 bg-gradient-to-r from-[#E07603] to-[#E07603]/90 text-white px-8 py-4 rounded-2xl hover:from-[#E07603]/90 hover:to-[#E07603]/80 transition-all font-semibold text-lg hover-lift shadow-xl">
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative">
                    <div class="rounded-3xl overflow-hidden shadow-2xl hover-lift">
                        <img src="src/assets/marieke_van_der_leest.png" alt="Professionele therapie begeleiding"
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        <div
                            class="bg-white p-6 rounded-2xl border border-gray-200 hover:border-[#E07603]/30 transition-all hover-lift">
                    ...
                    <div class="pt-6">
                        <a href="javascript:void(0);" onclick="scrollToContact()"
                            class="inline-flex items-center gap-3 bg-gradient-to-r from-[#E07603] to-[#E07603]/90 text-white px-8 py-4 rounded-2xl hover:from-[#E07603]/90 hover:to-[#E07603]/80 transition-all font-semibold hover-lift shadow-xl">
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6 md:px-8 lg:px-12 max-w-7xl">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="group relative">
                    <div
                        class="bg-gradient-to-br from-[#E07603]/5 to-[#E07603]/10 rounded-3xl p-8 md:p-10 border border-[#E07603]/20 hover:border-[#E07603]/40 transition-all hover-lift">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-[#E07603] to-[#E07603]/80 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        ...
                        <p class="text-gray-600 mb-6">Bewezen reductie in ziekteverzuim door preventieve aanpak en
                            vroege
                            interventie bij fysieke klachten.</p>
                    </div>
                </div>
                ...
                <div class="group relative">
                    <div
                        class="bg-gradient-to-br from-gray-800/5 to-gray-800/10 rounded-3xl p-8 md:p-10 border border-gray-800/20 hover:border-gray-800/40 transition-all hover-lift">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            <i data-lucide="users" class="w-8 h-8 text-white"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">95% Tevredenheid</h3>
                        <p class="text-gray-600 mb-6">Medewerkers waarderen onze persoonlijke aanpak en praktische
                            oplossingen voor hun werkplek.</p>
                    </div>
                </div>
                ...
                <div class="group relative">
                    <div
                        ...
                        <p class="text-gray-600 mb-6">Snelle reactie op acute klachten en binnen 48 uur een plan van
                            aanpak
                            voor uw organisatie.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="4" required
                                ...
                                placeholder="Vertel ons over uw situatie en hoe wij kunnen helpen..."></textarea>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <a href="tel:+31612345678"
                                    class="inline-flex items-center gap-2 text-[#E07603] hover:text-white transition-colors">
