    ...
    <div class="container mx-auto px-6 md:px-8 lg:px-12 py-4 max-w-7xl">
        <div class="flex justify-between items-center">
            <a href="/Glu/jaar_3/Fysiekcoach/" class="hover-lift group">
                <img src="/Glu/jaar_3/Fysiekcoach/src/assets/fysiekcoach_test_logo.png" alt="Fysiekcoach"
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div
                                                ...
                                                Ergonoom</div>
                                            <div class="text-sm text-gray-600 mt-1">Werkplekoptimalisatie en ergonomisch
                                                advies</div>
                                        </div>
                                    </div>
                                </a>
                                <a href="/Glu/jaar_3/Fysiekcoach/bedrijfs-oefentherapeut"
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-600 mt-1">Preventie, herstel en begeleiding
                                            </div>
                                        </div>
                                    </div>
                                </a>
